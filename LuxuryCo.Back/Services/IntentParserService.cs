...
- GENERATE_IMAGE (Diseñar o generar una imagen/outfit de una prenda, probador virtual, probar prenda en línea, o frases de creación/diseño como 'hazme una camisa', 'créame un vestido', 'dibuja un traje', 'pruébame esta camisa', 'cómo me queda', 'ver puesto', 'diseña', 'genera', 'crea', 'hacer', 'crear')
